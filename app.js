const CARD_TYPES = {
  ...
  cringe: { label: "хайп или зашквар" },
  alpaca: { label: "нямкет-челлендж" },
};
...
const CARDS = [
  ...
  { type: "cringe", text: "написать «можно вопрос?» и исчезнуть на 12 минут: хайп или зашквар? голосуем с аргументами." },
  { type: "cringe", text: "голосовое на 5 минут, где смысл был 8 секунд: хайп или зашквар?" },
  { type: "cringe", text: "сказать «я без негатива» и дальше устроить разбор полётов: хайп или зашквар?" },
  { type: "cringe", text: "быть онлайн и делать вид, что сообщение не существует: хайп или зашквар?" },
  { type: "cringe", text: "сказать «мне всё равно» и спорить до финального босса: хайп или зашквар?" },
  { type: "cringe", text: "писать «ахах» без единой эмоции в душе: хайп или зашквар?" },
  { type: "cringe", text: "говорить «я быстро», ещё не начав собираться: хайп или зашквар?" },
  { type: "cringe", text: "поставить точку в коротком сообщении и забрать у всех тепло: хайп или зашквар?" },
  { type: "cringe", text: "ответить «пон» на сообщение, где человек реально старался: хайп или зашквар?" },
  { type: "cringe", text: "кинуть мем вместо извинения: хайп или зашквар?" },
  { type: "cringe", text: "сказать «я не обиделся» голосом человека, который запомнил всё: хайп или зашквар?" },
  { type: "cringe", text: "обсуждать планы час и в итоге никуда не пойти: хайп или зашквар?" },
  { type: "cringe", text: "начать сообщение со «слушай», чтобы всем стало понятно: сейчас будет тяжело." },
  { type: "cringe", text: "открыть сообщение, закрыть сообщение, забыть ответить навсегда: хайп или зашквар?" },
  { type: "cringe", text: "сделать вид, что «случайно» не заметил просьбу: хайп или зашквар?" },
  { type: "cringe", text: "называть себя sigma после самого обычного решения: хайп или зашквар?" },
  { type: "cringe", text: "потерять aura points и пытаться объяснить, что так и было задумано: хайп или зашквар?" },
  { type: "cringe", text: "сказать «я не в ресурсе» на просьбу передать салфетку: хайп или зашквар?" },
  { type: "cringe", text: "сделать dab в 2026, но с полной уверенностью: хайп или зашквар?" },
  { type: "cringe", text: "написать «сорри, только увидел», когда все знают, что нет: хайп или зашквар?" },

  { type: "alpaca", text: "нямкет просит оправдание: придумайте, почему ваша команда опоздала на важный квест 2016. чем хуже звучит, тем лучше." },
  { type: "alpaca", text: "нямкет требует aura audit: назовите поступок, за который ваша команда прямо сейчас потеряла бы 50 aura points." },
  { type: "alpaca", text: "нямкет включает vine: придумайте 6-секундный скетч про вашу команду. начало, поворот, позорный финал." },
  { type: "alpaca", text: "нямкет забрал воздух: объясните вайб вашей команды ровно пятью словами. если смешно — +1, если убило — +2." },
  { type: "alpaca", text: "нямкет включает суд: обвините вашу команду в одном смешном преступлении против здравого смысла. остальные голосуют." },
  { type: "alpaca", text: "нямкет любит риск: за 15 секунд назовите мем 2016, который описывает вашу команду. успели и смешно — +2." },
  { type: "alpaca", text: "нямкет запрещает нормальность: начните ответ словами «официальная версия такая…» и объясните любой странный поступок команды." },
  { type: "alpaca", text: "нямкет требует улику: покажите предмет рядом и докажите, что он идеально описывает вашу команду." },
  { type: "alpaca", text: "нямкет режет пафос: самый уверенный участник молчит, а другой объясняет, почему ваша команда main character." },
  { type: "alpaca", text: "нямкет открывает комментарии: придумайте спорное мнение про 2016, а другая команда задаёт один неприятный вопрос." },
  { type: "alpaca", text: "нямкет объявляет блиц: за 20 секунд придумайте фразу, после которой команда теряет aura points. если зашло двум людям — +2." },
  { type: "alpaca", text: "нямкет дал mute: один участник показывает мем 2016 жестами, команда угадывает и объясняет выбор." },
  { type: "alpaca", text: "нямкет требует трейлер: представьте вашу команду как фильм, который никто не просил, но все почему-то смотрят." },
  { type: "alpaca", text: "нямкет ставит лимит: опишите самого опасного npc в школе без слова «ну»." },
  { type: "alpaca", text: "нямкет даёт право вето: соседняя команда запрещает вам одно слово, а вы объясняете свой командный brainrot." },
  { type: "alpaca", text: "нямкет просит рекламу: продайте вашу команду как странное приложение из 2016 года." },
  { type: "alpaca", text: "нямкет включает режим учителя: начните с «так, внимание» и объясните, почему ваш плохой план на самом деле гениален." },
  { type: "alpaca", text: "нямкет требует заголовок: придумайте название новости про вашу команду, а потом объясните, что случилось." },
  { type: "alpaca", text: "нямкет делает обмен: придумайте диагноз своей команде, а другая команда должна улучшить его одним предложением." },
  { type: "alpaca", text: "нямкет закрывает эфир: опишите человека с максимальным 2016 вайбом одним сообщением в чат." },
];

const STORAGE_KEY = "sonya-level-17-state";
const CARD_SET_VERSION = "cards-100-v4";
const screens = {
